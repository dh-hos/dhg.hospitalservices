...
Start-Process -WindowStyle Hidden -Wait -FilePath "C:\adv\adv.exe" -ArgumentList ($Config.PathAdvancedInstallerProjectFile+' '+$Config.PathAdvancedInstallerCommandFile)
